                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="slide-10 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/1.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/2.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/3.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/4.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/5.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/6.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/7.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/8.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/9.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="<?php echo base_url() ?>assets/images/kids/insta/10.jpg" alt="" class=" img-fluid">
                                    <div class="overlay">
                                        <i class="fa fa-instagram"  aria-hidden="true"></i>
                                    </div>
                                </div>
                ...
                <div class="col-xl-4 col-lg-12 about-section">
                    ...
                    <div class="footer-content">
                        <div class="footer-logo">
                            <img src="<?php echo base_url() ?>assets/images/icon/brand-logo/5.png" alt="">
                        </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="<?php echo base_url() ?>assets/images/product/1.jpg">
                        </a>
                ...
                <li>
                    <div class="media">
                        <a href="#">
                            <img alt="" class="mr-3" src="<?php echo base_url() ?>assets/images/product/2.jpg">
                        </a>
                        <div class="media-body">
                            <a href="#">
                                <h4>item name</h4>
                ...
                <li>
                    <div class="media">
                        <a href="#"><img alt="" class="mr-3" src="<?php echo base_url() ?>assets/images/product/3.jpg"></a>
                        <div class="media-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg addtocart">
                                ...
                                <div class="media">
                                    <a href="#">
                                        <img class="img-fluid  pro-img" src="<?php echo base_url() ?>assets/images/product/4.jpg" alt="">
                                    </a>
                                    ...
                                    <div class="row" id="upsell_product">
                                            ...
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page.html">
                                                        <img src="<?php echo base_url() ?>assets/images/product/1.jpg" class="img-fluid  mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page.html">
                                                        <img src="<?php echo base_url()?>assets/images/product/6.jpg" class="img-fluid  mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page.html">
                                                        <img src="<?php echo base_url() ?>assets/images/product/13.jpg" class="img-fluid  mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
                                        ...
                                        <div class="product-box col-sm-3 col-6">
                                            <div class="img-wrapper">
                                                <div class="front">
                                                    <a href="product-page.html#">
                                                        <img src="<?php echo base_url() ?>assets/images/product/19.jpg" class="img-fluid  mb-1" alt="cotton top">
                                                    </a>
                                                </div>
                                                <div class="product-detail">
                                                    <h6><a href="#"><span>cotton top</span></a></h6>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img"><img src="<?php echo base_url() ?>assets/images/product/14.jpg" alt="" class="img-fluid "></div>
                    </div>
        ...
        <div class="setting-body">
            ...
            <div class="setting-contant">
                <ul class="color-box">
                    ...
                    <li class="active"><a href="#" class="color10" ></a></li>
