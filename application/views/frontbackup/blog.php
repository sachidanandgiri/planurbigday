        ...
        <div class="row">
                ...
                <div class="blog-sidebar">
                    <div class="theme-card">
                        ...
                        <ul class="recent-blog">
                            <li>
                                <div class="media"><img class="img-fluid " src="../assets/images/blog/2.jpg" alt="Generic placeholder image">
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="../assets/images/blog/7.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="../assets/images/blog/4.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
                            ...
                            <li>
                                <div class="media"><img class="img-fluid " src="../assets/images/blog/6.jpg" alt="Generic placeholder image">
                                    <div class="media-body align-self-center">
                                        <h6>25 Dec 2018</h6>
                                        <p>0 hits</p>
                                    </div>
            ...
            <div class="col-xl-9 col-lg-8 col-md-7 order-sec">
                <div class="row blog-media">
                    <div class="col-xl-6">
                        <div class="blog-left">
                            <a href="#"><img src="../assets/images/blog/8.jpg" class="img-fluid  bg-img" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                ...
                <div class="row blog-media">
                    <div class="col-xl-6">
                        <div class="blog-left">
                            <a href="#"><img src="../assets/images/blog/9.jpg" class="img-fluid  bg-img" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="blog-right">
                ...
                <div class="row blog-media">
                    <div class="col-xl-6">
                        <div class="blog-left">
                            <a href="#"><img src="../assets/images/blog/10.jpg" class="img-fluid  bg-img" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="blog-right">
                ...
                <div class="row blog-media">
                    <div class="col-xl-6">
                        <div class="blog-left">
                            <a href="#"><img src="../assets/images/blog/11.jpg" class="img-fluid  bg-img" alt=""></a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="blog-right">
