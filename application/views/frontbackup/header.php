...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/images/favicon/5.png" type="image/x-icon"/>
    <title>Home</title>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" id="color" href="<?php echo base_url() ?>assets/css/color10.css">
            ...
            <div class="col-12">
                <div class="header-section">
                    ...
                    <div class="brand-logo">
                        <a href="index.html"> <img src="<?php echo base_url() ?>assets/images/icon/brand-logo/5.png" class="" alt=""></a>
                    </div>
                    ...
                    <div class="nav-icon">
                        <ul>
                            <li class="onhover-div setting-icon">
                                <div><img src="<?php echo base_url() ?>assets/images/icon/settings.png" class=" img-fluid setting-img" alt="">
                            ...
                            <li class="onhover-div search-3">
                                <div onclick="openSearch()">
                                    ...
                                    <img src="<?php echo base_url() ?>assets/images/icon/l-1/search.png" class=" img-fluid search-img" alt="">
                                </div>
                            ...
                            <li class="onhover-div wishlist-icon" onclick="openWishlist()">
                                <img src="<?php echo base_url() ?>assets/images/icon/l-1/wishlist.png" alt=""  class="wishlist-img">
                            ...
                            <li class="onhover-div user-icon" onclick="openAccount()">
                                <img src="<?php echo base_url() ?>assets/images/icon/l-1/user.png" alt="" class="user-img">
                            ...
                            <li class="onhover-div cart-icon" onclick="openCart()">
                                <img src="<?php echo base_url() ?>assets/images/icon/l-1/shopping-cart.png" alt="" class="cart-image">
                                <i class="ti-shopping-cart mobile-icon"></i>
                                <div class="cart  icon-detail">
                                    <h6 class="up-cls"><span>3 item</span></h6>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/1.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
                                                                    <li><a target="_blank" href="#">Mobile phones</a></li>
                                                                    <li><a target="_blank" href="#">televisions</a></li>
                                                                    <li><a target="_blank" href="#">refrigerator</a></li>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/2.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/3.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/4.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/5.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
                                                ...
                                                <div class="col-xl-2 mega-box">
                                                    <div class="link-section">
                                                        <div class="demo">
                                                            ...
                                                            <div class="menu-content">
                                                                <img src="<?php echo base_url() ?>assets/images/mega-menu/6.jpg" class="mega-menu-img  img-fluid" alt="">
                                                                <ul>
