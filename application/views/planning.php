        ...
        <div class="row">
            <div class="intro-block">
                <div class="col-md-offset-1 col-md-10">
                    <div class=" "><img src="<?php echo base_url() ?>assets/images/hero-to-do.png" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cta-block text-center ">
                        ...
                        <a href="#" class="btn btn-primary mt20">Start Planning Today</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="section-space100">
        <div class="container">
          ...
          Manage To-Dos</h1>
                ...
                <div class="col-md-6">
                    <div class="template-box"><img src="<?php echo base_url() ?>assets/images/to-do-app-screen.png" alt="" class="img-responsive"></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-offset-1 col-md-6">
                    <div class="tool-description text-center">
                        ...
                        <a href="#"><img src="<?php echo base_url() ?>assets/images/button-app-store.png" alt=""></a>
                        <a href="#"><img src="<?php echo base_url() ?>assets/images/button-google-play.png" alt=""></a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="app-mobile">
                        <img src="<?php echo base_url() ?>assets/images/app-screen.png" alt="" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
