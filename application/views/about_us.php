                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="call-to-action well-box mt30">
                                ...
                                <img src="<?php echo base_url() ?>assets/images/cycle-graphic.png" alt="" class="graphic img-responsive"> <a href="#" class="btn btn-default btn-lg">Get start today</a> </div>
                        </div>
                        <div class="col-md-12 team-section" id="team">
                            <h1>Our Founder</h1>
                            <div class="row">
                                <div class="col-md-4"><img src="<?php echo base_url() ?>assets/images/founder.jpg" alt="" class="img-responsive img-circle"></div>
                                <div class="col-md-8">
                                    <h2>Tisha chauhan</h2>
                            ...
                            <div class="row team-section">
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="<?php echo base_url() ?>assets/images/team-pic1.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="<?php echo base_url() ?>assets/images/team-pic7.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="<?php echo base_url() ?>assets/images/team-pic8.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                                ...
                                <div class="col-md-3 text-center team-block">
                                    <div class="team-pic">
                                        <!-- team pic -->
                                        <a href="#"><img src="<?php echo base_url() ?>assets/images/team-pic2.jpg" class="img-responsive" alt=""></a>
                                    </div>
                                    <!-- /.team pic -->
                    ...
                    <div class="row">
                        <div class="col-md-12 how-it-works" id="howwork">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center how-it-icon"> <img src="<?php echo base_url() ?>assets/images/vendor-1.svg" alt=""> </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 text-center how-it-icon"> <img src="<?php echo base_url() ?>assets/images/list.svg" alt=""> </div>
                                <div class="col-md-6 how-it-desc">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center how-it-icon"> <img src="<?php echo base_url() ?>assets/images/vendor-done.svg" alt=""> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <ul class="timeline">
                                <li>
                                    ...
                                    <div class="timeline-panel">
                                        <div class="history-pic"> <img src="<?php echo base_url() ?>assets/images/post-pic.jpg" class="img-responsive" alt=""> </div>
